...
function Lablet.buildActivity(builder)
	...
	local graphLayout = sheet:addHorizontalGroupLayout()
	sheet:addMotionAnalysisGraph(experimentFreeFall, graphLayout):showXVsYPosition()
	sheet:addMotionAnalysisGraph(experimentFreeFall, graphLayout):showTimeVsYSpeed()
	...
	local graphLayout = sheet:addHorizontalGroupLayout()
	local graph = sheet:addMotionAnalysisGraph(experimentUpDown, graphLayout)
    ...
    local graphLayout = sheet:addHorizontalGroupLayout()
    sheet:addMotionAnalysisGraph(experimentProjectile, graphLayout):showXVsYPosition()
    sheet:addMotionAnalysisGraph(experimentProjectile, graphLayout):showTimeVsYSpeed()
	sheet:addQuestion("How does the vertical velocity vary with time?")
	...
	local graphLayout = sheet:addHorizontalGroupLayout()
	sheet:addMotionAnalysisGraph(experimentProjectile, graphLayout):showTimeVsXSpeed()
	sheet:addMotionAnalysisGraph(experimentProjectile, graphLayout):showTimeVsYSpeed()
